...
ReadingAnnotations::ReadingAnnotations(string path1, string path2)
{
...
string ReadingAnnotations::Annotations_Image_Paths()
{
    ...
    image_path = "C:/Users/User/Desktop/Face Detection Staj/Test Images/" + image_path_in_dataset + ".jpg"; //path of FDDB dataset in my computer + image_path_in_dataset
